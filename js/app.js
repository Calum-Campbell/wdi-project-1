...
function populateKeyboard(i, emojis){
  $('.keyboard').prepend("<li class='emojis-icon' style='background-image:url("+emojis.src+");width:156px;height:157px;' id="+ emojis.value +">"+emojis.value+"</li>");
  // populateScreen;
}
...
//populate the screeen with a random emoji object value.
  ...
  // (function (){
   ...
   setInterval(function() {
    counter ++;
    if(counter < 25){
   $('.game-screen').html(shuffledEmojis[counter].value);
    console.log(counter);
  }else{
